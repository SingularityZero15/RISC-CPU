...
HD_PWD='C:/Users/gjk19/Desktop/Digital Circuit/Vivado Project/RISC CPU/RISC CPU.runs/rom_256x16b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_256x16b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_256x16b.tcl
